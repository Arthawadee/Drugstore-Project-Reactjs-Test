...
<Grid columns={2} relaxed="very">
          <Grid.Column>
            ...
            <List bulleted>
              ...
              <List.Item>ภาควิชาวิศวกรรมโยธาและสิ่งแวดล้อม 6396-6397</List.Item>
              <List.Item>ภาควิชาอุตสาหการ 6201-6202</List.Item>
              <List.Item>กลุ่มสาขาวิชาเทคโนโลยีการจัดการระบบสารสนเทศ 6301-6303</List.Item>
              <List.Item>กลุ่มสาขาวิชาโลจิสติกส์และระบบขนส่งทางราง 6619</List.Item>
              
              <List.Item>สำนักงานคณบดี
                  <List.List>
              ...
              <List.Item>สำนักงานจัดการกลยุทธ์
                  <List.List>
                      <List.Item>งานยุทธศาสตร์และงบประมาณ 6060-6063</List.Item>
                      <List.Item>งานพัฒนาคุณภาพ 6090-6093</List.Item>
                      <List.Item>งานสื่อสารองค์กรและวิเทศสัมพันธ์ 6044-6047, 6088</List.Item>
                  </List.List>
              </List.Item>
              
              <List.Item>สำนักงานการศึกษา 6028-6030, 6033-6034
                  <List.List>
              ...
              <List.Item>สำนักงานวิจัย นวัตกรรมและบริการวิชาการ 6052-6055
                  <List.List>
              ...
              <List.Item>ศูนย์เครือข่ายวิจัยประยุกต์ทางเทคโนโลยีหุ่นยนต์และชีวการแพทย์</List.Item>
              <List.Item>ศูนย์การจัดการโลจิสติกส์และโซ่อุปทานและสุขภาพ</List.Item>
            </List>
          </Grid.Column>
          <Grid.Column>
            <Image
