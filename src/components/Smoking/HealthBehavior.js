...
const HealthBehavior = observer( class HealthBehavior extends Component {
  constructor(props) {
    super(props);
    this.state = {
      value1: "",
  ...
  setHealthBehavior = () => {
    this.props.store.setHealthBehavior(
      ...
      this.state.value3, this.state.disable3, this.state.month, this.state.year,
      this.state.value4, this.state.value4Amount,
      this.state.value5, this.state.value6
    );
  };
