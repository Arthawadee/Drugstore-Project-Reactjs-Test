        ...
        /> */}
          ...
          <Step.Group ordered attached="top" size='large'>
            ...
            <Step
              ...
              completed={this.state.store.smokingComplete.complete2}
            >
              <Step.Content>
            ...
            <Step
              ...
              completed={this.state.store.smokingComplete.complete3}
            >
              <Step.Content>
            ...
            <Step
              ...
              completed={this.state.store.smokingComplete.complete4}
            >
              <Step.Content>
            ...
            <Step
              ...
              completed={this.state.store.smokingComplete.complete5}
            >
              <Step.Content>
            ...
            <Step
              ...
              completed={this.state.store.smokingComplete.complete6}
            >
              <Step.Content>
          ...
          <Segment attached>
            <div id="FamilyInfo" style={{ display: "block" }}>
              <FamilyInfo store={this.state.store} />
            </div>
            <div id="HealthBehavior" style={{ display: "none" }}>
              <HealthBehavior store={this.state.store} />
            </div>
            <div id="SmokingCessationForm" style={{ display: "none" }}>
              <SmokingCessationForm store={this.state.store} />
            </div>
            <div id="SmokingCessationPlan" style={{ display: "none" }}>
              <SmokingCessationPlan store={this.state.store} />
            </div>
            <div id="SmokingCessationMedicine" style={{ display: "none" }}>
              <SmokingCessationMedicine store={this.state.store} />
            </div>
            <div id="SmokingFollowUpA5" style={{ display: "none" }}>
              <SmokingFollowUpA5 store={this.state.store} />
            </div>
          </Segment>
          <TopButton />
        </div>
