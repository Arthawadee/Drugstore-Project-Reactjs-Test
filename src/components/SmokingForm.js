...
import { Form, Button, Radio, Select,Input } from "semantic-ui-react";
            ...
            <Form.Group widths="equal">
              <Form.Field
                ...
                onChange={(e, { value }) => {
                  ...
                  }else {this.setState({disable2_1: true})
              ...
              <Form.Field
                ...
                onChange={(e, { value }) => {
                  ...
                  }else {this.setState({disable2_2: true})
...
{/* ________________________________________________________________________________________________________________________________________________ */}
        ...
        <h2 className="ui icon aligned header" style={{textAlign: "center"}}>แผนการเลิกบุหรี่
        </h2>
